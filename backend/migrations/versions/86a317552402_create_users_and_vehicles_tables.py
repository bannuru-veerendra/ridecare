...
def upgrade() -> None:
    ...
    op.create_index(op.f('idx_vehicles_registration_number'), 'vehicles', ['registration_number'], unique=True)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('idx_vehicles_registration_number'), table_name='vehicles')
